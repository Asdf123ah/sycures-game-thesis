...
useEffect(() => {
    const fetchWinRates = async () => {
      try {
        ...
        const basicComputerMobileSkillResponse = await axios.get(`https://sycures-api-00e6e06e3ebc.herokuapp.com/api/user/${userId}/winrate?category=Basic Computer and Mobile Skill`);
...
useEffect(() => {
    const fetchWinRates = async () => {
      try {
        // Pass the category as a query parameter
        const internetSkillResponse = await axios.get(`https://sycures-api-00e6e06e3ebc.herokuapp.com/api/user/${userId}/winrate?category=Internet Skill`);
...
useEffect(() => {
    const fetchWinRates = async () => {
      try {
        // Pass the category as a query parameter
        const communicationSkillResponse = await axios.get(`https://sycures-api-00e6e06e3ebc.herokuapp.com/api/user/${userId}/winrate?category=Communication Skill`);
...
useEffect(() => {
    const fetchWinRates = async () => {
      try {
        // Pass the category as a query parameter
        const informationLiteracySkillResponse = await axios.get(`https://sycures-api-00e6e06e3ebc.herokuapp.com/api/user/${userId}/winrate?category=Information Literacy Skill`);
